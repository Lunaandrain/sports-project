...
<div style="margin:20px">
    <form action="" method="post" >
        ...
        <button type="button" id="submit"   class="layui-btn layui-btn-radius layui-btn-norma">可选择的运动员</button>
...
<script>
    ...
    function deleteById(a_id) {
        console.log(a_id)
        $.get("/match/deleteath",{'a_id':a_id},function (data) {
            if(data.ok){
                //删除成功
            ...
            $.post("/match/showath",{
                ...
                for(var i =0 ; i < athletes.length; i++){
                    ...
                    $('#articleBody').append("<tr>\n" +
                        ...
                        "                <td>" + athlete.t_id+ "</td>\n" +
                        "                <td>\n" +
                        "   <a class=\"aaa\"  onclick=\"deleteById('"+athlete.a_id+"')\"  href='javascript:void(0)'>删除运动员</a>&nbsp;\n" +
