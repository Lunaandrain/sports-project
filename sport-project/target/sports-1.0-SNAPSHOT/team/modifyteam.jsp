...
<div class="layui-container" style="margin-top: 20px">
    <div class="layui-row">
        <form class="layui-form" id="updatateamform">
            <input type="hidden" name="t_id" value="${sessionScope.team.t_id}">

            <!-- 提示：如果你不想用form，你可以换成div等任何一个普通元素 -->
            <div class="layui-form-item">
                <label class="layui-form-label">用户名</label>
                <div class="layui-input-block">
                    <input type="text" name="username" value="${sessionScope.team.username}" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <button type="button" onclick="updatateam()"  class="layui-btn" lay-submit lay-filter="*">修改</button>
...
<script>
    layui.use('form', function(){
        ...
        $("#oldPwd").blur(function (){
            ...
            $.post("/team/verifyoldpwd",{'oldpwd':$(this).val()},function (data){
                if(!data.ok){
            ...
            //定义layui中的方法
            window.updatateam= function updatateam(){

                var forms =$('#updatateamform').serialize();
                console.log(forms)

                $.post("/team/updatateam",forms,function (data){
                    if(!data){
                        ...
                        setTimeout(function () {
                            ...
                            layer.msg('操作成功', {icon: 1,time:1000},function(){  //延时跳转并提示
                                ...
                                window.parent.location.href = "/team/loginOut";; //刷新父级窗口
