...
<div class="layui-container" style="margin-top: 20px">
  <div class="layui-row">
    <form class="layui-form" id="updatarefereeform">
      <input type="hidden" name="r_id" value="${sessionScope.referee.r_id}">
      <!-- 提示：如果你不想用form，你可以换成div等任何一个普通元素 -->
      <div class="layui-form-item">
        <label class="layui-form-label">用户名</label>
        <div class="layui-input-block">
          <input type="text" name="username" value="${sessionScope.referee.username}" autocomplete="off" class="layui-input">
        </div>
      </div>
      <div class="layui-form-item">
      ...
      <div class="layui-form-item">
        <div class="layui-input-block">
          <button type="button" onclick="updatareferee()"  class="layui-btn" lay-submit lay-filter="*">修改</button>
...
<script>
  layui.use('form', function(){
    ...
    $("#oldPwd").blur(function (){
      ...
      $.post("/referee/verifyoldpwd",{'oldpwd':$(this).val()},function (data){
        if(!data.ok){
          layer.msg(data.mess,{offset:'t'})
            ...
            //定义layui中的方法
            window.updatareferee= function updatareferee(){
              console.log("haha")
              var forms =$('#updatarefereeform').serialize();
              console.log(forms)

              $.post("/referee/updatareferee",forms,function (data){
                if(!data){
                  ...
                  setTimeout(function () {
                    ...
                    layer.msg('操作成功', {icon: 1,time:1000},function(){  //延时跳转并提示
                      ...
                      window.parent.location.href = "/referee/loginOut";; //刷新父级窗口
