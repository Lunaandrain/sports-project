...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header">
        <div class="layui-logo layui-hide-xs layui-bg-black">代表队系统</div>
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                ...
                <li class="layui-nav-item ">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="./2.jsp" target="1">领队信息</a></dd>
                        <dd><a href="./3.jsp" target="1">队医信息</a></dd>
                        <dd><a href="./4.jsp" target="1">运动员信息</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="./5.jsp" target="1">查看赛程</a>
                </li>
                <li class="layui-nav-item ">
                    <a href="./6.jsp" target="1">成绩查询</a>
